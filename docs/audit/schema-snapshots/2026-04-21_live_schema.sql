...
\restrict duydYAHh12E7zoNjMJfdg7sbzRriHKEdGmnFJggmdoWeeOQZcZFFFnvnm8Ln64f
...
--
-- Name: objects Doctor photos public read; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Doctor photos public read" ON storage.objects FOR SELECT USING ((bucket_id = 'doctor-photos'::text));


--
-- Name: objects GP delete own doctor-photos folder; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "GP delete own doctor-photos folder" ON storage.objects FOR DELETE TO authenticated USING (((bucket_id = 'doctor-photos'::text) AND (split_part(name, '/'::text, 1) = (auth.uid())::text)));


--
-- Name: objects GP update own doctor-photos folder; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "GP update own doctor-photos folder" ON storage.objects FOR UPDATE TO authenticated USING (((bucket_id = 'doctor-photos'::text) AND (split_part(name, '/'::text, 1) = (auth.uid())::text))) WITH CHECK (((bucket_id = 'doctor-photos'::text) AND (split_part(name, '/'::text, 1) = (auth.uid())::text)));


--
-- Name: objects GP upload own doctor-photos folder; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "GP upload own doctor-photos folder" ON storage.objects FOR INSERT TO authenticated WITH CHECK (((bucket_id = 'doctor-photos'::text) AND (split_part(name, '/'::text, 1) = (auth.uid())::text)));
...
\unrestrict duydYAHh12E7zoNjMJfdg7sbzRriHKEdGmnFJggmdoWeeOQZcZFFFnvnm8Ln64f
