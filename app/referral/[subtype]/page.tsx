...
export default function ReferralIntakePage({
  ...
  const config = getServiceConfig("referral");
  ...
  async function handleSubmit() {
    ...
    if (duration.trim())
      notesParts.push(`Duration of symptoms:\n${duration.trim()}`);
    if (seenBefore.trim())
      notesParts.push(`Seen before for this:\n${seenBefore.trim()}`);
    if (hospital.trim())
      notesParts.push(`Preferred hospital / clinic:\n${hospital.trim()}`);
          ...
          <div className="space-y-5 lg:col-span-2">
            <div>
              <label className="block text-sm font-medium text-[#0F2744]">
                Describe your symptoms or reason for this referral
            ...
            />
            <TextInput
              label="Have you been seen for this before?"
              value={seenBefore}
              onChange={setSeenBefore}
            />
            <TextInput
              label="Preferred hospital or clinic (if any)"
              value={hospital}
            ...
            <div className="rounded-2xl border border-gray-100 bg-white p-6 shadow-sm lg:sticky lg:top-24">
              ...
              <dl className="mt-5 space-y-3 text-sm">
                <div className="flex items-center justify-between">
                  ...
                  <dd className="font-medium text-[#0F2744]">Referral</dd>
                </div>
